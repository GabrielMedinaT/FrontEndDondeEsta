...
const NavBar = () => {
  ...
  {isLoggedIn ? (
    <>
      <div className={darkmode ? "lateral-Dark" : "lateral"}> 
      <div className="lateral-ext">
      ...
      <button
          ...
          <button
            className={`btn ${resetAnimation ? "reset-animation" : ""}`}
            onClick={Logout}
          >
            <div className="sign">
